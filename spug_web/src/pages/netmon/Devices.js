...
import { Table, Tag, Space, Select, Input, Form, Modal, InputNumber, message } from 'antd';
...
export default observer(function Devices() {
  ...
  return (
    <div>
      ...
      <Table rowKey="id" loading={store.devFetching} columns={columns} dataSource={store.devices}/>
